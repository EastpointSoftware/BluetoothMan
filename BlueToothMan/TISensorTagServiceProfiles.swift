...
public struct TISensorTag {
    ...
    public struct MagnetometerService : ServiceConfigurable {
        ...
        public struct Data : RawArrayDeserializable, CharacteristicConfigurable, StringDeserializable {
            ...
            public init?(stringValue:[String:String]) {
                let xRawInit = int16ValueFromStringValue("xRaw", values:stringValue)
    ...
    public struct TemperatureService : ServiceConfigurable {
        ...
        public struct Data : RawArrayDeserializable, CharacteristicConfigurable, StringDeserializable {
            ...
            public init?(stringValue:[String:String]) {
                let objectRawInit   = int16ValueFromStringValue("objectRaw", values:stringValue)
                let ambientRawInit  = int16ValueFromStringValue("ambientRaw", values:stringValue)
    ...
    public struct BarometerService : ServiceConfigurable {
        ...
        public struct Calibration : RawArrayPairDeserializable, CharacteristicConfigurable, StringDeserializable {
            ...
            public init?(stringValue:[String:String]) {
                let c1Init = uint16ValueFromStringValue("c1", values:stringValue)
...
public class TISensorTagServiceProfiles {
    ...
    public class func create() {
        ...
        //***************************************************************************************************
        // Accelerometer Service
        let accelerometerService = ConfiguredServicesProfile<TISensorTag.AccelerometerService>()
        ...
        let magnetometerService = ConfiguredServicesProfile<TISensorTag.MagnetometerService>()
        ...
        //***************************************************************************************************
        // Gyroscope Service
        let gyroscopeService = ConfiguredServicesProfile<TISensorTag.GyroscopeService>()
        ...
        //***************************************************************************************************
        // Temperature Service
        let temperatureService = ConfiguredServicesProfile<TISensorTag.TemperatureService>()
        ...
        //***************************************************************************************************
        // Barometer Service
        let barometerService = ConfiguredServicesProfile<TISensorTag.BarometerService>()
        ...
        //***************************************************************************************************
        // Hygrometer Service
        let hygrometerService = ConfiguredServicesProfile<TISensorTag.HygrometerService>()
        ...
        //***************************************************************************************************
        // Sensor Tag Test Service
        let sensorTagTestService = ConfiguredServicesProfile<TISensorTag.SensorTagTestService>()
        ...
        //***************************************************************************************************
        // Key Pressed Service
        let keyPressedService = ConfiguredServicesProfile<TISensorTag.KeyPressedService>()
